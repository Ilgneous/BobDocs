...
<template>
    <div class="plot-container">
        <div class="plot-controls">
            <button v-if="!isRunning" @click="play" class="plot-btn">
                &#9654; Play
            </button>
            <button v-else @click="pause" class="plot-btn">
                &#9646;&#9646; Pause
            </button>
            <button @click="resetAnim" class="plot-btn plot-btn-muted">
                &#8635; Reset
            </button>
        </div>
