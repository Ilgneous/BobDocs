...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"BobDyn","description":"A high-fidelity, open-source vehicle simulation framework","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/bob.png","siteTitle":"BobDyn","nav":[{"text":"Startup Guide","link":"/startup-guide/"},{"text":"Use Guide","link":"/use-guide/"},{"text":"Documentation","items":[{"text":"BobLib","link":"/boblib/"},{"text":"BobSim","link":"/bobsim/"},{"text":"Reference","link":"/reference/"}]}],"sidebar":{"/startup-guide/":[{"text":"Startup Guide","items":[{"text":"Overview","link":"/startup-guide/"}]}],"/use-guide/":[{"text":"Use Guide","items":[{"text":"Overview","link":"/use-guide/"}]}],"/reference/":[{"text":"Reference","collapsed":false,"items":[{"text":"Overview","link":"/reference/"},{"text":"Vehicle Dynamics","collapsed":false,"items":[{"text":"Vehicle Performance Metrics","link":"/reference/metrics"}]},{"text":"Control Foundations","collapsed":false,"items":[{"text":"Control Theory","link":"/reference/control-theory"}]}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/BobDyn"}],"footer":{"message":"Released as open-source vehicle simulation tooling.","copyright":"Copyright © 2026 BobDyn"},"search":{"provider":"local"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const VPPage = /* @__PURE__ */ _export_sfc(_sfc_main$Q, [["ssrRender", _sfc_ssrRender$1]]);
...
const VPSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-1d5665e3"]]);
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.DsSOqp1Z.js"));
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    function simulate() {
      const dt = 0.04, T = 28, omega_n = 1, zeta = 0.05;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "plot-container" }, _attrs))} data-v-583bb6e7><div class="plot-controls" data-v-583bb6e7>`);
      if (!isRunning.value) {
        _push(`<button class="plot-btn" data-v-583bb6e7>▶ Play</button>`);
      } else {
        _push(`<button class="plot-btn" data-v-583bb6e7>▮▮ Pause</button>`);
      }
      _push(`<button class="plot-btn plot-btn-muted" data-v-583bb6e7>↻ Reset</button></div><div class="chart-area" data-v-583bb6e7><canvas data-v-583bb6e7></canvas></div></div>`);
    };
  }
};
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/BangBangPlot.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const BangBangPlot = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-583bb6e7"]]);
  ...
  setup(__props) {
    ...
    const loadPdfjs = async () => {
      if (!pdfjsModulePromise) {
        pdfjsModulePromise = (async () => {
          ...
          const workerUrl = (await import("./pdf.worker.LHH0k7eC.js")).default;
    ...
    const renderDocument = async () => {
      ...
      try {
        ...
        if (token !== renderToken || !pdfDocument) return;
        const availableWidth = Math.max(320, containerWidth.value || ((_a = containerRef.value) == null ? void 0 : _a.clientWidth) || 0);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: containerRef,
        class: "pdf-viewer"
      }, _attrs))} data-v-ce391589>`);
      if (loading.value && pageNumbers.value.length === 0) {
        _push(`<div class="pdf-status" data-v-ce391589>Loading PDF…</div>`);
      } else if (error.value) {
        _push(`<div class="pdf-status pdf-status-error" data-v-ce391589>${ssrInterpolate(error.value)}</div>`);
      } else {
        _push(`<div class="pdf-pages" data-v-ce391589><!--[-->`);
        ssrRenderList(pageNumbers.value, (pageNumber) => {
          _push(`<div class="pdf-page" data-v-ce391589><canvas data-v-ce391589></canvas></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div>`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/PdfViewer.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const PdfViewer = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ce391589"]]);
const _sfc_main$1 = {
  __name: "PIDPlot",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    function simulate(kp, ki, kd) {
      const dt = 0.04, T = 20, omega_n = 1, zeta = 0.05;
      const N = Math.floor(T / dt);
      const r = 1;
      let x = 0, v = 0, integral = 0, prevE = r;
      const times = [], positions = [];
      for (let i = 0; i < N; i++) {
        const e = r - x;
        integral += e * dt;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "plot-container" }, _attrs))} data-v-a227e3b8><div class="sliders" data-v-a227e3b8><label data-v-a227e3b8><span class="label-text" data-v-a227e3b8>K<sub data-v-a227e3b8>p</sub> = ${ssrInterpolate(Kp.value)}</span><input type="range"${ssrRenderAttr("value", Kp.value)} min="0" max="25" step="0.5" data-v-a227e3b8></label><label data-v-a227e3b8><span class="label-text" data-v-a227e3b8>K<sub data-v-a227e3b8>i</sub> = ${ssrInterpolate(Ki.value)}</span><input type="range"${ssrRenderAttr("value", Ki.value)} min="0" max="10" step="0.25" data-v-a227e3b8></label><label data-v-a227e3b8><span class="label-text" data-v-a227e3b8>K<sub data-v-a227e3b8>d</sub> = ${ssrInterpolate(Kd.value)}</span><input type="range"${ssrRenderAttr("value", Kd.value)} min="0" max="10" step="0.25" data-v-a227e3b8></label></div><div class="chart-area" data-v-a227e3b8><canvas data-v-a227e3b8></canvas></div><p class="hint" data-v-a227e3b8>Try setting K<sub data-v-a227e3b8>i</sub> = 0 to see steady-state error, or K<sub data-v-a227e3b8>d</sub> = 0 to see overshoot.</p></div>`);
    };
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/PIDPlot.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const PIDPlot = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a227e3b8"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (isVisible.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({
          ...
          "aria-hidden": "true"
        }, _attrs))} data-v-40757b06><span class="label" data-v-40757b06>Scroll</span><span class="arrow" data-v-40757b06>↓</span></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/ScrollIndicator.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ScrollIndicator = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-40757b06"]]);
const RawTheme = {
  extends: theme,
  Layout() {
...
async function createApp() {
  ...
  app.component("Mermaid", _sfc_main$19);
